/**
 * React Media Component Library Types
 */
...
export interface VideoPlayerProps {
  ...
  /** Inline styles */
  style?: CSSProperties
  /** Custom controls slot (rendered after built-in controls) */
  children?: ReactNode
  /** Custom controls slot (rendered before built-in right controls) */
